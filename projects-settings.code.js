define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@16.14.0", "react-dom@16.14.0", "@beyond-js/inspect@0.0.1/models.ts", "@beyond-js/inspect@0.0.1/reactive-model", "@beyond-js/ui@0.0.1/spinner", "@beyond-js/ui@0.0.1/form", "@beyond-js/ui@0.0.1/preload-text", "@beyond-js/workspace@1.0.5/ds-select", "@beyond-js/ui@0.0.1/modal", "@beyond-js/workspace@1.0.5/hooks", "@beyond-js/workspace@1.0.5/core-components", "@beyond-js/workspace@1.0.5/ds-contexts", "@beyond-js/workspace@1.0.5/project-distributions.code", "@beyond-js/kernel@0.1.9/texts"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8, dependency_9, dependency_10, dependency_11, dependency_12, dependency_13, dependency_14) {
  ...
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/workspace@1.0.5/projects-settings",
      "multibundle": true
    },
    "type": "code"
  }, _amd_module.uri).package();
  ;
  __pkg.dependencies.update([['react', dependency_1], ['react-dom', dependency_2], ['@beyond-js/inspect/models.ts', dependency_3], ['@beyond-js/inspect/reactive-model', dependency_4], ['@beyond-js/ui/spinner', dependency_5], ['@beyond-js/ui/form', dependency_6], ['@beyond-js/ui/preload-text', dependency_7], ['@beyond-js/workspace/ds-select', dependency_8], ['@beyond-js/ui/modal', dependency_9], ['@beyond-js/workspace/hooks', dependency_10], ['@beyond-js/workspace/core-components', dependency_11], ['@beyond-js/workspace/ds-contexts', dependency_12], ['@beyond-js/workspace/project-distributions.code', dependency_13], ['@beyond-js/kernel/texts', dependency_14]]);
  const {
    module
  } = __pkg.bundle;
