define(["exports", "module", "@beyond-js/kernel@0.1.7/bundle", "@beyond-js/kernel@0.1.7/core"], function (_exports, _amd_module, dependency_0, dependency_1) {
  ...
  const bimport = specifier => {
    const dependencies = new Map([["@beyond-js/kernel", "0.1.3"], ["@beyond-js/local", "0.1.2"], ["socket.io", "4.5.4"], ["socket.io-client", "4.5.4"], ["@beyond-js/backend", "0.1.2"], ["@beyond-js/dashboard", "1.0.2"]]);
