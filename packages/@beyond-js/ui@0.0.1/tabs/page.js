define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@16.14.0", "react-dom@16.14.0", "@beyond-js/ui@0.0.1/empty", "@beyond-js/ui@0.0.1/import", "@beyond-js/ui@0.0.1/icon", "@beyond-js/ui@0.0.1/ripple", "@beyond-js/ui@0.0.1/tabs"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7) {
  "use strict";
  ...
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/ui@0.0.1/tabs/page"
    },
    "type": "page"
  ...
  ***************/
  ...
  SCSS STYLES
  **********/
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/ui/tabs/page', '#graphs-tabs-page .container-test{margin:auto;position:relative;background:#fff;width:300px;height:350px}');
