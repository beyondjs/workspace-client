  ...
  *********/
  ...
  class BeyondButton extends React.Component {
    ...
    async componentDidMount() {
      ...
      if (!this.props.title) return; // this.title = await bimport('tippy');
