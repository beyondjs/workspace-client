define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@16.14.0", "react-dom@16.14.0", "@beyond-js/ui@0.0.1/image", "@beyond-js/ui@0.0.1/swiper-slider", "@beyond-js/ui@0.0.1/video-player", "@beyond-js/ui@0.0.1/icon"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6) {
  "use strict";
  ...
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/ui@0.0.1/publication"
    },
    "type": "code"
  }, _amd_module.uri).package();
  ;
  __pkg.dependencies.update([['react', dependency_1], ['react-dom', dependency_2], ['@beyond-js/ui/image', dependency_3], ['@beyond-js/ui/swiper-slider', dependency_4], ['@beyond-js/ui/video-player', dependency_5], ['@beyond-js/ui/icon', dependency_6]]);
  const {
    module
  } = __pkg.bundle;
  ...
  *************************/
  ...
  class TrashBeyondPublication extends React.Component {
    ...
    render() {
      ...
      }, graph.picture && graph.picture.uploaded && /*#__PURE__*/React.createElement(BeyondImage, {
        className: "img-post",
        innerRef: this.image,
  ...
  *********************/
  ...
  function BeyondPublication({
    ...
    }, asset.picture && /*#__PURE__*/React.createElement(BeyondImage, {
      className: "img-post",
      size: '800x600',
  ...
  ********/
  ...
  function Icons({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "icons"
    }, config && config.icons && config.icons.map(icon => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(BeyondIconButton, {
      icon: icon.icon,
  ...
  *********************/
  ...
  class OpenGraphYoutube extends React.Component {
    ...
    render() {
      ...
      }, /*#__PURE__*/React.createElement(BeyondVideoPlayer, {
        id: "jwvideo",
        type: "youtube",
    ...
    render() {
      ...
      if (openGraph.entity !== 'oglink') {
        if (media && media.images.length > 1) {
          output = /*#__PURE__*/React.createElement(BeyondSwiperSlider, {
            entries: media.images,
            analyze: true
          });
        } else {
          output = /*#__PURE__*/React.createElement(BeyondImage, {
            ref: this.image,
        ...
        video ? output = /*#__PURE__*/React.createElement(BeyondVideoPlayer, {
          id: "jwvideo",
          url: video.url,
          poster: video.image,
          "video-id": "video-id",
