define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "react-dom@18.2.0", "@beyond-js/ui@0.0.1/icon", "@beyond-js/ui@0.0.1/form"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4) {
  "use strict";
  ...
  _exports.useBeyondModalContext = _exports.hmr = _exports.__beyond_pkg = _exports.BeyondModalContext = void 0;
  /*************
  LEGACY IMPORTS
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/ui@0.0.1/modal"
    },
    "type": "code"
  }, _amd_module.uri).package();
  ;
  __pkg.dependencies.update([['react', dependency_1], ['react-dom', dependency_2], ['@beyond-js/ui/icon', dependency_3], ['@beyond-js/ui/form', dependency_4]]);
  const {
    module
  } = __pkg.bundle;
  ...
  ***********/
  ...
  const BeyondModalContext = _exports.BeyondModalContext = React.createContext();
