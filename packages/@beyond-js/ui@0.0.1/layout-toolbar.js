define(["exports", "module", "@beyond-js/kernel@0.1.7/bundle", "react@16.14.0", "react-dom@16.14.0", "@beyond-js/ui@0.0.1/image", "@beyond-js/ui@0.0.1/form", "@beyond-js/ui@0.0.1/icon", "@beyond-js/dashboard@1.0.2/core-components", "@beyond-js/ui@0.0.1/modal"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7) {
  "use strict";
  ...
  _exports.Page = Page;
  _exports.svgs = _exports.hmr = _exports.__beyond_pkg = _exports.Toolbar = void 0;
  /*************
  LEGACY IMPORTS
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/ui@0.0.1/layout-toolbar"
    },
    "type": "code"
  }, _amd_module.uri).package();
  ;
  __pkg.dependencies.update([['react', dependency_1], ['react-dom', dependency_2], ['@beyond-js/ui/image', dependency_3], ['@beyond-js/ui/form', dependency_4], ['@beyond-js/ui/icon', dependency_5], ['@beyond-js/dashboard/core-components', dependency_6], ['@beyond-js/ui/modal', dependency_7]]);
  const {
    module
  } = __pkg.bundle;
  ...
  ************/
  ...
  SCSS STYLES
  **********/
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/ui/layout-toolbar', '.ds-toolbar{display:flex;position:sticky;align-items:center;justify-content:center;height:60px;top:0;transition:all .3s ease-in;background:var(--app-header-background);z-index:1;box-shadow:0 5px 5px -5px #333}.ds-toolbar .beyond-element-image.app-logo{height:70%;padding:0;margin:0}.ds-toolbar .beyond-element-image.app-logo img{height:100%}');
