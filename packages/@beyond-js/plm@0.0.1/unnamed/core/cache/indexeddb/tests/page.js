define(["exports", "module", "@beyond-js/kernel@0.1.1/bundle", "react@16.14.0", "react-dom@16.14.0", "@beyond-js/plm@0.0.1/plm-indexed-db"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3) {
  "use strict";
  ...
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/plm@0.0.1/unnamed/core/cache/indexeddb/tests/page"
    },
    "type": "page"
  ...
  **********/
  ...
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/plm/unnamed/core/cache/indexeddb/tests/page', '');
