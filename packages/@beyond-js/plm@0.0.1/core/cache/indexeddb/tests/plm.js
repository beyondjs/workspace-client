define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@16.14.0", "react-dom@16.14.0", "@beyond-js/plm@0.0.1/plm-indexed-db"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3) {
  "use strict";
  ...
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/plm@0.0.1/core/cache/indexeddb/tests/plm"
    },
    "type": "page"
  ...
  ************/
  ...
  SCSS STYLES
  **********/
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/plm/core/cache/indexeddb/tests/plm', '');
  const ims = new Map();
