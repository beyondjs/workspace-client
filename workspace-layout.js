define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "react-dom@18.2.0", "@beyond-js/inspect@0.0.1/reactive-model", "@beyond-js/workspace@1.1.1/notify", "@beyond-js/workspace@1.1.1/layout-toolbar", "@beyond-js/ui@0.0.1/modal", "@beyond-js/ui@0.0.1/form", "@beyond-js/ui@0.0.1/image", "@beyond-js/ui@0.0.1/perfect-scrollbar", "@beyond-js/ui@0.0.1/toast"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8, dependency_9, dependency_10) {
  ...
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/workspace@1.1.1/workspace-layout"
    },
    "type": "layout"
  ...
  ************/
  ...
  const DsDocs = _exports.DsDocs = new DashboardDocs();
  /**************
  FILE: layout.js
  **************/
