define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "react-dom@18.2.0", "@beyond-js/ui@0.0.1/icon", "@beyond-js/workspace@1.1.1/core-components", "@beyond-js/workspace@1.1.1/ds-contexts"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5) {
  "use strict";
  ...
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/workspace@1.1.1/ds-navigator"
    },
    "type": "code"
  ...
  ********/
  ...
  const NavigatorContext = _exports.NavigatorContext = React.createContext();
