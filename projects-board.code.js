define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "react-dom@18.2.0", "@beyond-js/inspect@0.0.1/models.ts", "@beyond-js/inspect@0.0.1/reactive-model", "@beyond-js/ui@0.0.1/spinner", "@beyond-js/ui@0.0.1/form", "@beyond-js/ui@0.0.1/preload-text", "@beyond-js/workspace@1.1.1/hooks", "@beyond-js/workspace@1.1.1/core-components", "@beyond-js/workspace@1.1.1/ds-contexts", "@beyond-js/kernel@0.1.9/texts", "@beyond-js/workspace@1.1.1/models"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8, dependency_9, dependency_10, dependency_11, dependency_12) {
  ...
  *************/
  ...
  ;
  __pkg.dependencies.update([['react', dependency_1], ['react-dom', dependency_2], ['@beyond-js/inspect/models.ts', dependency_3], ['@beyond-js/inspect/reactive-model', dependency_4], ['@beyond-js/ui/spinner', dependency_5], ['@beyond-js/ui/form', dependency_6], ['@beyond-js/ui/preload-text', dependency_7], ['@beyond-js/workspace/hooks', dependency_8], ['@beyond-js/workspace/core-components', dependency_9], ['@beyond-js/workspace/ds-contexts', dependency_10], ['@beyond-js/kernel/texts', dependency_11], ['@beyond-js/workspace/models', dependency_12]]);
  const {
    module
  } = __pkg.bundle;
  ...
  ********/
  ...
  function ApplicationsBoard() {
    ...
    let apps = AppsController.packages.map(item => /*#__PURE__*/React.createElement(ProjectItem, {
      texts: texts,
      key: item.id,
      item: item
    }));
    ...
    }, texts.actions.create), /*#__PURE__*/React.createElement("span", null, applications.items.length, " ", headerTexts.title))), /*#__PURE__*/React.createElement(SearchForm, null)), /*#__PURE__*/React.createElement("section", {
      className: cls
    }, apps)));
  }
  ...
  *********/
  ...
  function SearchForm() {
    ...
    const onChange = event => {
      ...
      AppsController.filterText = event.currentTarget.value;
    };
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "ds-packages__searcher-container bg-secondary"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      ref: searcher,
      placeholder: "Write here to filter packages...",
  ...
  ******************/
  ...
  const AppsController = new class Controller extends ReactiveModel {
    ...
    set filterText(value) {
      ...
      this.#packages = this.#applications.items.filter(item => {
    ...
    setApplications(applications) {
      ...
      this.#packages = applications.items;
  ...
  SCSS STYLES
  **********/
  const legacyStyles = beyondLegacyStyles.register('@beyond-js/workspace/projects-board.code', '.after-loading{animation:show 1s 1}@keyframes show{0%{opacity:0}100%{height:100%;opacity:1}}.no-scroll{overflow:hidden!important}.preload-container{display:flex;position:absolute;position:absolute;top:0;left:0;bottom:0;right:0;background:#000;z-index:3;align-items:center;justify-content:center;transition:all .3s ease-in}.preload-container .animation-container{display:flex;align-items:center;justify-content:center}.preload-container.finishing-preload{background:#ff0}.preload-container .overlay{position:absolute;bottom:-100px;left:0;background:red;z-index:5;transform:skewY(11deg);width:100%;transition:all 2ms ease-in;opacity:0;height:0}.preload-container .overlay.close{transition:all .3s ease-in;height:130vh;opacity:1}.ds-board__list-container .ds-item_list{background:var(--beyond-element-primary-background-color);border-bottom:1px solid #f0f0f0;padding:1.5rem 2.5rem;display:grid;justify-content:space-between;align-items:center;flex-flow:row;cursor:pointer;transition:all .2s ease-in;grid-template-columns:1fr 1fr}.ds-board__list-container .ds-item_list.ds-item_list--sm{padding:.75rem 2.5rem}.ds-board__list-container .ds-item_list:last-child{border-bottom:none;margin-bottom:20px}.ds-board__list-container .ds-item_list:hover{transition:all .2s ease-in-out;background:var(--beyond-element-primary-hover-background-color)}.ds-board__list-container .ds-item_list .right-col{text-align:right;justify-content:flex-end}.ds-board__list-container .ds-item_list .p1,.ds-board__list-container .ds-item_list .p2,.ds-board__list-container .ds-item_list h3,.ds-board__list-container .ds-item_list h4{margin:0;padding:0}.ds-board__list-container .ds-item_list .actions,.ds-board__list-container .ds-item_list .item-information{display:flex;gap:8px}.ds-board__list-container .ds-item_list .actions .action-icon:hover .beyond-icon,.ds-board__list-container .ds-item_list .item-information .action-icon:hover .beyond-icon{border:1px solid var(--beyond-primary-accent-color);background:var(--beyond-primary-accent-color);transition:all .3s ease-in}.ds-board__list-container .ds-item_list .actions .beyond-icon-button.error__icon .beyond-icon,.ds-board__list-container .ds-item_list .item-information .beyond-icon-button.error__icon .beyond-icon{stroke:var(--danger);fill:var(--danger)}.ds-board__list-container .ds-item_list .actions .beyond-icon,.ds-board__list-container .ds-item_list .actions .beyond-icon-button,.ds-board__list-container .ds-item_list .item-information .beyond-icon,.ds-board__list-container .ds-item_list .item-information .beyond-icon-button{stroke:var(--text-color);fill:var(--text-color)}.ds-board__list-container .ds-item_list .actions .beyond-icon-button.error__icon,.ds-board__list-container .ds-item_list .actions .beyond-icon.error__icon,.ds-board__list-container .ds-item_list .item-information .beyond-icon-button.error__icon,.ds-board__list-container .ds-item_list .item-information .beyond-icon.error__icon{stroke:var(--danger);fill:var(--danger)}.ds-board__list-container .ds-item_list .blank-page{min-height:50vh;display:grid;align-items:center;justify-content:center;text-align:center}.preload-container{height:100vh;width:100vw;overflow:hidden}.ds-projects-board{height:100%}.ds-projects-board .beyond-icon-button.button--fetching{height:3.2rem;width:3.2rem;border:1px solid var(--beyond-secondary-color);opacity:.5}.ds-projects-board .ds-board__list-container{padding-top:1rem;height:100%}.ds-projects-board .ds-board__list-container.empty-container{height:calc(100% - 100px)}.ds-projects-board .ds-packages__searcher-container{padding:1rem;margin-top:1rem}');
