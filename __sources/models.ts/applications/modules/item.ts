import {Item, ItemProperty, ItemSpecs, ItemsProperty} from "@beyond-js/plm/core";
import {module} from "beyond_context";
import type {Application} from "../item";
import type {Module} from "../../modules/item";
import type {Bundle} from "../../bundles/item";
import {ApplicationModuleDeclarations} from "./declarations";
...
class ApplicationModule extends Item {
    ...
    get declaration(): ApplicationModuleDeclarations {
    ...
    constructor(specs: ItemSpecs) {
        ...
        this.#declaration = new ApplicationModuleDeclarations(this);
    ...
    getBundle(name: string): Bundle | undefined {
