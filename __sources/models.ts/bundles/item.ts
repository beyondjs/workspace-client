import {CollectionProperty, Item, ItemProperty, ItemSpecs, ItemsProperty} from "@beyond-js/plm/core";
import {module} from "beyond_context";
import type {Module} from "../modules/item";
import type {Packager} from "./packagers/item";
...
class Bundle extends Item {
    ...
    get packagers(): Map<string, Packager> {
        return <ItemsProperty>this.properties.get('packagers');
    }
