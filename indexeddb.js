define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle"], function (_exports, _amd_module, dependency_0) {
  ...
  _exports.hmr = _exports.__beyond_pkg = _exports.BeyondDB = void 0;
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/workspace@1.1.1/indexeddb"
    },
    "type": "code"
  ...
  *************/
  ...
  const BeyondDB = _exports.BeyondDB = new DBManager();
