define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "react-dom@18.2.0", "@beyond-js/inspect@0.0.1/reactive-model", "@beyond-js/workspace@1.1.1/hooks", "@beyond-js/workspace@1.1.1/models", "@beyond-js/workspace@1.1.1/core-components", "@beyond-js/workspace@1.1.1/ds-contexts", "@beyond-js/kernel@0.1.9/texts"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8) {
  ...
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/workspace@1.1.1/ds-notifications",
      "multibundle": true
    },
    "type": "code"
  }, _amd_module.uri).package();
  ;
  __pkg.dependencies.update([['react', dependency_1], ['react-dom', dependency_2], ['@beyond-js/inspect/reactive-model', dependency_3], ['@beyond-js/workspace/hooks', dependency_4], ['@beyond-js/workspace/models', dependency_5], ['@beyond-js/workspace/core-components', dependency_6], ['@beyond-js/workspace/ds-contexts', dependency_7], ['@beyond-js/kernel/texts', dependency_8]]);
  const {
    module
  } = __pkg.bundle;
  ...
  **********/
  ...
  const DsNotificationContext = _exports.DsNotificationContext = React.createContext(null);
  ...
  *************/
  ...
  const DSNotifications = _exports.DSNotifications = new class extends ReactiveModel {
    /**
