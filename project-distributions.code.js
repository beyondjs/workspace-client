define(["exports", "module", "@beyond-js/kernel@0.1.9/bundle", "react@16.14.0", "react-dom@16.14.0", "@beyond-js/inspect@0.0.1/models.ts", "@beyond-js/ui@0.0.1/spinner", "@beyond-js/ui@0.0.1/preload-text", "@beyond-js/workspace@1.1.1/project-distributions-form", "@beyond-js/workspace@1.1.1/ds-select", "@beyond-js/ui@0.0.1/form", "@beyond-js/workspace@1.1.1/hooks", "@beyond-js/workspace@1.1.1/texts-binder", "@beyond-js/ui@0.0.1/icon", "@beyond-js/workspace@1.1.1/core-components", "@beyond-js/workspace@1.1.1/ds-contexts"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8, dependency_9, dependency_10, dependency_11, dependency_12, dependency_13) {
  ...
  *************/
  ...
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/workspace@1.1.1/project-distributions",
      "multibundle": true
    },
    "type": "code"
  }, _amd_module.uri).package();
  ;
  __pkg.dependencies.update([['react', dependency_1], ['react-dom', dependency_2], ['@beyond-js/inspect/models.ts', dependency_3], ['@beyond-js/ui/spinner', dependency_4], ['@beyond-js/ui/preload-text', dependency_5], ['@beyond-js/workspace/project-distributions-form', dependency_6], ['@beyond-js/workspace/ds-select', dependency_7], ['@beyond-js/ui/form', dependency_8], ['@beyond-js/workspace/hooks', dependency_9], ['@beyond-js/workspace/texts-binder', dependency_10], ['@beyond-js/ui/icon', dependency_11], ['@beyond-js/workspace/core-components', dependency_12], ['@beyond-js/workspace/ds-contexts', dependency_13]]);
  const {
    module
  } = __pkg.bundle;
