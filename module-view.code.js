define(["exports", "module", "@beyond-js/kernel@0.0.22/bundle", "react@16.14.0", "react-dom@16.14.0", "@beyond-js/ui@0.0.1/spinner", "@beyond-js/ui@0.0.1/form", "dayjs@1.11.5", "@beyond-js/dashboard@0.0.1/core-components", "@beyond-js/dashboard@0.0.1/hooks", "@beyond-js/dashboard@0.0.1/texts-binder", "@beyond-js/dashboard@0.0.1/ds-contexts"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8, dependency_9) {
  ...
  ********/
  ...
  function ModuleBoard(props) {
    ...
    if (!specs.moduleId || !textsReady || !model?.ready || specs.moduleId !== model.id) {
      return /*#__PURE__*/React.createElement(DSSpinner, null);
    }
  ...
  *******************/
  ...
  function Consumers() {
    ...
    return /*#__PURE__*/React.createElement("article", {
    ...
    }, !!!output.length && /*#__PURE__*/React.createElement("span", null, texts.labels.empty), fetching ? /*#__PURE__*/React.createElement(DSIconButton, null, " ", /*#__PURE__*/React.createElement(BeyondSpinner, {
      active: true,
      ...
      icon: analyzerIcon,
      onClick: onLoad
    }), output.length > 0 && /*#__PURE__*/React.createElement(DSIconButton, {
      className: "circle secondary",
      icon: icon
